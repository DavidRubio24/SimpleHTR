...
# Aquí se defie la clase Model que es una función con parametros
# para predecir el texto manuscrito en imagenes.
# Con ejemplos etiquetados se puede elegir los parametros con los
# que ejor se hacen las predicciones, esto es entrenar.
#
# Nuestro modelo es una CNN para extraer iformación de la imágen
# y encima de esta una RNN para hacer la predicción teniendo en
# cuenta el contexto.
# También es necesario un CTC para poder entrenar el modelo.

# __future__ permite usar carateristicas de futuras versiones de
# python, así este codigo se puede ejecutar con python 2.
...
# Definimos un enumerado para identificar el algoritmo con el
# que decidiremos cual es la palabras más razonable que cuadra.
class DecoderType:
  BestPath = 0
  BeamSearch = 1
  WordBeamSearch = 2
...
class Model: 
  ...
  imgSize = (128, 32)
  # Cantidad máxima de caracteres que nuestro modelo puede predecir que tiene la imágen.
  maxTextLen = 32
  ...
  def __init__(self, charList, decoderType=DecoderType.BestPath, mustRestore=False):
    ...
    Parameters:
      charList: list of characters that we'll be able to read.
      decoderType: determina el algoritmo para buscar la palabra más probable
      mustRestore (bool): cargar los parámetros del modelos desde archivo
    """
